...
public class SearchServiceImpl implements SearchService {
        ...
        try {
            ...
            TransportClient client = new TransportClient(settings) {
                ...
                public TransportClient addTransportAddress(TransportAddress transportAddress) {
                    return super.addTransportAddress(transportAddress);
                }
            }
            ...
            e.printStackTrace();
            throw new HiShopException("查询ES索引库出错");
        }
    }
    ...
    public String quickSearch(String key) {
        ...
        String result = null;
        try {
            result = HttpUtil.sendGet("http://" + ES_CONNECT_IP + ":" + ES_NODE_CLIENT_PORT + "/item/itemList/_search?q=productName:" + keyword);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
